---
name: glossario
description: Glossario dei termini business dell'officina.
allowed-tools: [Read]
user-invocable: false
paths: ["backend/src/booking/**", "backend/src/work-order/**", "backend/src/invoice/**", "backend/src/estimate/**", "backend/src/dvi/**", "backend/src/parts/**"]
---
