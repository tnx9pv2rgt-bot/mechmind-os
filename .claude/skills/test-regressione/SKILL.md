...
description: "Esegue subset critico di test (10% più impattanti) per feedback rapido su PR. Target: <3 min vs 15 min full suite. Identifica regressioni su booking/payment/auth/invoice prima del merge."
user-invocable: true
