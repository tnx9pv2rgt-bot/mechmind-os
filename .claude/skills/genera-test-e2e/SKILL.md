---
name: genera-test-e2e
description: "Genera test Playwright E2E per golden path critici: booking flow, payment checkout, auth login/logout, invoice creation. Target: zero regressioni su flussi core dopo ogni deploy."
user-invocable: true
