---
name: integrita-db
description: "Audit integrità DB: index mancanti, FK senza index, tenantId su ogni tabella, transazioni multi-step, PII non crittografata, N+1 query. Si attiva automaticamente su schema Prisma e service files."
