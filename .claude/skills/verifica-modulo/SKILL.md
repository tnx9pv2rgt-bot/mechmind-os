---
name: verifica-modulo
description: Verifica completezza modulo NestJS prima dei test. Score 0-100 su 5 categorie. Controlla struttura file, tenantId, state machine, frontend. Elenca gap prioritizzati se score < 70.
