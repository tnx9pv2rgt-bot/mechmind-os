      ...
      <LiquidGlassCard>
        <div className="space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">Verifica 2FA</h1>
            <p className="text-gray-500">Inserisci il codice generato dalla tua app authenticator</p>
          </div>
          ...
          <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/40 border border-white/60">
            ...
            <div>
              <p className="font-medium text-gray-900">Codice di verifica</p>
              <p className="text-sm text-gray-500">Apri l'app authenticator e inserisci il codice</p>
            </div>
          </div>
          ...
          <div className="relative">
            <Input
              ...
              maxLength={6}
              className={cn(
                'h-16 w-full rounded-2xl border-0 bg-white/60 text-center',
                'text-3xl font-semibold tracking-[0.5em] text-gray-900',
          ...
          <Button 
            ...
            className="w-full rounded-xl text-gray-500 hover:text-gray-700 hover:bg-white/40"
          >
