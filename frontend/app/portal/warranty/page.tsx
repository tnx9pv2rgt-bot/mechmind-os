  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mb-6 p-5 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-blue-100"
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-apple-dark mb-1">
              Copertura Garanzia
            </h3>
            <p className="text-sm text-apple-gray">
              Le garanzie coprono i difetti di fabbricazione e i guasti meccanici. 
              Per i reclami, contattaci con il numero di polizza.
            </p>
          </div>
        </div>
      </motion.div>
