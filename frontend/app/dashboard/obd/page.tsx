        ...
        <div className='px-8 py-5 flex items-center justify-between'>
          <div>
            ...
            <p className='text-apple-gray dark:text-[#636366] text-body mt-1'>
              Monitoraggio real-time e predizione intelligente
            </p>
          </div>
          <div className='flex items-center gap-3'>
            <div
              className={`flex items-center gap-2 px-4 py-2 rounded-full ${connected ? 'bg-apple-green/10 text-apple-green' : 'bg-apple-gray/10 text-apple-gray'}`}
            >
      ...
      >
        ...
        {!connected && (
          <motion.div variants={cardVariants}>
            <AppleCard
              featured
              className='bg-gradient-to-br from-apple-purple to-violet-600 text-white'
            >
            ...
            <AppleCard>
              <AppleCardContent className='flex flex-col items-center justify-center py-16 text-center'>
                <div className='w-16 h-16 rounded-2xl bg-apple-light-gray dark:bg-[#353535] flex items-center justify-center mb-6'>
                  <WifiOff className='h-8 w-8 text-apple-gray dark:text-[#636366]' />
                </div>
                <h3 className='text-title-2 font-semibold text-apple-dark dark:text-[#ececec] mb-2'>
                  Nessun dato OBD disponibile
                </h3>
                <p className='text-body text-apple-gray dark:text-[#636366] max-w-md'>
                  Collega un dispositivo OBD per iniziare il monitoraggio real-time del veicolo e
                  ricevere predizioni ML sui possibili guasti.
                </p>
              </AppleCardContent>
            </AppleCard>
          </motion.div>
              ...
              <AppleCardContent className='flex flex-col md:flex-row items-center gap-8'>
                <div className='relative'>
                  ...
                  <div className='absolute inset-0 flex flex-col items-center justify-center'>
                    <span className='text-5xl font-bold text-apple-dark dark:text-[#ececec]'>
                      78
                    </span>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-body text-apple-gray dark:text-[#636366] mb-6'>
                    Il tuo veicolo è in buone condizioni generali. Ci sono alcuni elementi che
                    richiedono attenzione nei prossimi 5,000 km.
                  </p>
          ...
          >
            {[
              ...
              },
              {
                ...
                unit: '°C',
                icon: Thermometer,
                color: 'from-apple-orange to-amber-600',
              },
              {
                label: 'Voltaggio',
                value: '14.2',
                unit: 'V',
                icon: Zap,
                color: 'from-apple-green to-emerald-600',
              },
              {
                label: 'Carico Motore',
                value: '18',
                unit: '%',
                icon: Activity,
                color: 'from-apple-purple to-violet-600',
              },
            ].map(item => (
              ...
              <AppleCardContent>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <div>
                    ...
                    <p className='text-footnote text-apple-gray dark:text-[#636366]'>
                      Basate sui dati OBD e algoritmi di machine learning
                    </p>
                  </div>
                </div>
                  ...
                  {[
                    ...
                    >
                      <div className='flex items-start justify-between mb-3'>
                        <div className='flex items-center gap-3'>
                          <AlertTriangle
                            className={`h-5 w-5 ${alert.severity === 'high' ? 'text-apple-red' : 'text-apple-orange'}`}
                          />
                          <h4 className='text-body font-semibold text-apple-dark dark:text-[#ececec]'>
                            {alert.component}
                          </h4>
                        </div>
                        <span
                      ...
                      <p className='text-body text-apple-gray dark:text-[#636366] mb-3'>
                        {alert.description}
                      </p>
                      <div className='flex items-center justify-between'>
                        <div className='text-footnote'>
                          <span className='text-apple-gray dark:text-[#636366]'>Azione: </span>
                          <span className='text-apple-dark dark:text-[#ececec] font-medium'>
                            {alert.action}
                          </span>
                        </div>
                        <span className='text-callout font-semibold text-apple-dark dark:text-[#ececec]'>
                          {alert.cost}
                        </span>
                      </div>
                    </div>
            ...
            <motion.div key={feature.title} variants={cardVariants}>
              <AppleCard>
                <AppleCardContent className='text-center'>
                  ...
                  <h3 className='text-title-3 font-semibold text-apple-dark dark:text-[#ececec] mb-2'>
                    {feature.title}
                  </h3>
                  <p className='text-footnote text-apple-gray dark:text-[#636366]'>
                    {feature.description}
