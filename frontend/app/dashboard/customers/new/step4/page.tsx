      ...
      <div className='fixed inset-0 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#212121] dark:to-[#212121] flex items-center justify-center p-4 overflow-hidden'>
        <div className='relative w-[min(900px,95vw)] h-[min(900px,95vh)]'>
          ...
          >
            ...
            <h2 className='text-3xl font-bold text-gray-900 dark:text-[#ececec] mb-4'>
              Cliente Creato!
            </h2>
        ...
        >
          ...
          <div className='space-y-3 text-sm'>
            <div className='flex justify-between items-center py-2 border-b border-gray-100 dark:border-[#424242]'>
              ...
              <span className='font-medium dark:text-[#ececec] px-3 py-1 bg-gray-100 dark:bg-[#353535] rounded-full'>
            ...
            <div className='flex justify-between items-center py-2 border-b border-gray-100 dark:border-[#424242]'>
              ...
              <span className='font-medium dark:text-[#ececec]'>
        ...
        >
          ...
          <div className='space-y-3 text-sm'>
            <div className='flex justify-between items-center py-2 border-b border-gray-100 dark:border-[#424242]'>
              ...
              <span className='font-medium font-mono dark:text-[#ececec]'>
                {formData.fiscalCode}
              </span>
            </div>
            {formData.vatNumber && (
          ...
          <div className='space-y-3 text-sm'>
            {formData.preferredChannel && (
              <div className='flex justify-between items-center py-2 border-b border-gray-100 dark:border-[#424242]'>
                ...
                <span className='font-medium capitalize dark:text-[#ececec]'>
                  {formData.preferredChannel}
                </span>
              </div>
            )}
            ...
            <div className='flex justify-between items-center py-2 border-b border-gray-100 dark:border-[#424242]'>
              ...
              <span
                className={`font-medium ${formData.marketingConsent ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
              >
              ...
              (
                ...
                >
                  <div className='flex justify-between items-center mb-2'>
                    <span className='font-semibold text-gray-900 dark:text-[#ececec]'>
                      {v.make} {v.model}
                    </span>
                    <span className='font-bold text-blue-600 bg-blue-100 dark:bg-blue-900/30 px-3 py-1 rounded-full text-sm'>
                      {v.plate}
                    </span>
                  </div>
