...
export default function Step4Page() {
  ...
  if (isSuccess) {
    return (
      <div className='fixed inset-0 bg-[var(--surface-secondary)] dark:bg-[var(--surface-tertiary)] flex items-center justify-center p-4 overflow-hidden'>
        <div className='relative w-[min(900px,95vw)] h-[min(900px,95vh)]'>
          <motion.div
            className='relative w-full h-full bg-[var(--surface-secondary)] dark:bg-[var(--surface-elevated)] rounded-2xl shadow-apple border border-[var(--border-default)]/20 dark:border-[var(--border-default)] flex flex-col items-center justify-center p-10 text-center'
          ...
          >
            ...
            <h2 className='text-headline text-[var(--text-primary)] dark:text-[var(--text-primary)] mb-4'>
              Cliente Creato!
            </h2>
            <p className='text-body text-[var(--text-tertiary)] dark:text-[var(--text-secondary)] mb-8 max-w-md'>
      ...
      >
        ...
        <div className='flex items-center gap-3 mb-6'>
          ...
          <div>
            ...
            <p className='text-[var(--text-tertiary)] dark:text-[var(--text-secondary)] text-footnote'>
        ...
        >
          ...
          <div className='flex items-start gap-3'>
            ...
            <Label
              htmlFor='gdprConsent'
              className='text-footnote leading-relaxed text-[var(--text-primary)] dark:text-[var(--text-primary)] cursor-pointer'
            >
          ...
          <div className='min-h-[20px] ml-7'>
            {gdprError && (
              <p
                ...
                role='alert'
                aria-live='assertive'
                className='text-[var(--status-error)] text-footnote mt-1'
              >
        ...
        >
          <div className='flex items-center gap-3 mb-4'>
            <div className='w-10 h-10 rounded-xl bg-[var(--brand)]/10 dark:bg-[var(--surface-hover)] flex items-center justify-center'>
              <Car className='w-5 h-5 text-[var(--brand)]' />
            </div>
            <h3 className='text-body font-semibold text-[var(--text-primary)] dark:text-[var(--text-primary)]'>
            ...
            {formData.vehicles?.map(
              (
                ...
                <motion.div
                  ...
                  className='bg-[var(--surface-secondary)]/30 dark:bg-[var(--surface-hover)] rounded-2xl p-4'
                >
                  <div className='flex justify-between items-center mb-2'>
                    <span className='text-body font-semibold text-[var(--text-primary)] dark:text-[var(--text-primary)]'>
                      {v.make} {v.model}
                    </span>
                    <span className='font-bold text-[var(--text-primary)] dark:text-[var(--text-primary)] bg-[var(--surface-secondary)] dark:bg-[var(--surface-active)] px-3 py-1 rounded-full text-footnote'>
                      {v.plate}
                    </span>
                  </div>
                  <div className='text-[var(--text-tertiary)] dark:text-[var(--text-secondary)] text-footnote flex items-center gap-4'>
                    <span>{v.year}</span>
                    <span>•</span>
