      ...
      >
        ...
        <div className='bg-white/80 dark:bg-[#2f2f2f]/80 backdrop-blur-xl rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-[#424242]'>
          <Label
            ...
            className='text-sm font-medium text-gray-700 dark:text-[#ececec] mb-3 block'
          >
            Tipo Cliente
          </Label>
          <Select
          ...
          >
            <SelectTrigger
              id='customerType'
              className='h-14 rounded-xl bg-white/80 dark:bg-[#2f2f2f]/80 border-gray-200 dark:border-[#424242]'
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
            ...
            <div>
              <div className='flex items-center justify-between mb-2'>
                <div className='flex items-center gap-2'>
                  <Label
                    htmlFor='email'
                    className='text-sm font-medium text-gray-700 dark:text-[#ececec]'
                  >
                    Email
                  </Label>
            ...
            <div className='flex items-start space-x-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-2xl border border-green-100 dark:border-green-700/30'>
              ...
              <div className='flex-1'>
                <Label
                  ...
                  className='font-medium text-gray-900 dark:text-[#ececec] cursor-pointer'
                >
                  Consenso marketing
                </Label>
