      ...
      <header className='bg-white/80 dark:bg-[#212121]/80 backdrop-blur-apple border-b border-apple-border/20 dark:border-[#424242]/50'>
        <div className='px-4 sm:px-8 py-5'>
          <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3'>
            <div>
              <h1 className='text-headline text-apple-dark dark:text-[#ececec]'>Registro Audit</h1>
                  ...
                  <table className='w-full'>
                    <thead>
                      <tr className='border-b border-apple-border/30 dark:border-[#424242]'>
                        <th className='text-left py-3 px-4 text-footnote font-medium text-apple-gray uppercase tracking-wider'>Data/Ora</th>
                        <th className='text-left py-3 px-4 text-footnote font-medium text-apple-gray uppercase tracking-wider'>Utente</th>
                        <th className='text-left py-3 px-4 text-footnote font-medium text-apple-gray uppercase tracking-wider'>Azione</th>
                        <th className='text-left py-3 px-4 text-footnote font-medium text-apple-gray uppercase tracking-wider'>Risorsa</th>
                        <th className='text-right py-3 px-4 text-footnote font-medium text-apple-gray uppercase tracking-wider'>Dettagli</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          {selectedEntry && (
            <div className='space-y-4 py-4'>
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <p className='text-footnote text-apple-gray dark:text-[#636366] uppercase tracking-wider'>Data/Ora</p>
                  <p className='text-body text-apple-dark dark:text-[#ececec]'>
                    {new Date(selectedEntry.timestamp).toLocaleString('it-IT')}
                  </p>
                </div>
                <div>
                  <p className='text-footnote text-apple-gray dark:text-[#636366] uppercase tracking-wider'>Utente</p>
                  <p className='text-body text-apple-dark dark:text-[#ececec]'>{selectedEntry.userName}</p>
                </div>
                <div>
                  <p className='text-footnote text-apple-gray dark:text-[#636366] uppercase tracking-wider'>Azione</p>
                  {getActionBadge(selectedEntry.action)}
                </div>
                <div>
                  <p className='text-footnote text-apple-gray dark:text-[#636366] uppercase tracking-wider'>Risorsa</p>
                  <p className='text-body text-apple-dark dark:text-[#ececec]'>
                    {selectedEntry.resource} ({selectedEntry.resourceId})
                  </p>
                </div>
                <div>
                  <p className='text-footnote text-apple-gray dark:text-[#636366] uppercase tracking-wider'>IP</p>
                  <p className='text-body text-apple-dark dark:text-[#ececec] font-mono text-sm'>
              ...
              {selectedEntry.details && (
                <div>
                  <p className='text-footnote text-apple-gray dark:text-[#636366] uppercase tracking-wider mb-2'>Dettagli</p>
                  <pre className='p-4 bg-apple-light-gray/50 dark:bg-[#353535] rounded-xl text-sm overflow-auto max-h-60 text-apple-dark dark:text-[#ececec]'>
