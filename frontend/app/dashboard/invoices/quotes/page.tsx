...
const mockQuotes: Quote[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'item-5',
        description: 'Pastiglie freni Brembo',
        type: 'parts',
        quantity: 1,
        unitPrice: 85,
        taxRate: 22,
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'item-9',
        description: 'Kit frizione Valeo',
        type: 'parts',
        quantity: 1,
        unitPrice: 850,
        taxRate: 22,
      ...
      {
        id: 'item-11',
        description: 'Manodopera specialistica',
        type: 'labor',
        quantity: 6,
        unitPrice: 55,
        taxRate: 22,
  ...
  },
  {
    ...
    items: [
      {
        id: 'item-12',
        description: 'Revisione impianto frenante completo',
        type: 'service',
        quantity: 1,
        unitPrice: 350,
        taxRate: 22,
      ...
      {
        id: 'item-13',
        description: 'Kit freni anteriori originali BMW',
        type: 'parts',
        quantity: 1,
        unitPrice: 680,
        taxRate: 22,
      ...
      {
        id: 'item-14',
        description: 'Kit freni posteriori originali BMW',
        type: 'parts',
        quantity: 1,
        unitPrice: 520,
        taxRate: 22,
      ...
      {
        id: 'item-15',
        description: 'Liquido freni DOT 4',
        type: 'parts',
        quantity: 2,
        unitPrice: 25,
        taxRate: 22,
  ...
  },
  {
    ...
    items: [
      {
        id: 'item-17',
        description: 'Sostituzione ammortizzatori anteriori',
        type: 'service',
        quantity: 1,
        unitPrice: 180,
        taxRate: 22,
      ...
      {
        id: 'item-18',
        description: 'Coppia ammortizzatori Bilstein',
        type: 'parts',
        quantity: 2,
        unitPrice: 145,
        taxRate: 22,
  ...
  },
  {
    ...
    items: [
      {
        id: 'item-20',
        description: 'Tagliando 60.000 km',
        type: 'service',
        quantity: 1,
        unitPrice: 320,
        taxRate: 22,
      ...
      {
        id: 'item-21',
        description: 'Filtri originali Mercedes (olio, aria, abitacolo)',
        type: 'parts',
        quantity: 1,
        unitPrice: 180,
        taxRate: 22,
      ...
      {
        id: 'item-22',
        description: 'Olio motore sintetico 0W40',
        type: 'parts',
        quantity: 6,
        unitPrice: 35,
        taxRate: 22,
      ...
      {
        id: 'item-23',
        description: 'Candele accensione',
        type: 'parts',
        quantity: 4,
        unitPrice: 45,
        taxRate: 22,
