...
export default function PublicLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[var(--surface-tertiary)] dark:bg-[var(--surface-tertiary)] flex flex-col">
      {/* Header */}
      <header className="w-full border-b border-[var(--border-default)] dark:border-[var(--border-strong)] bg-[var(--surface-secondary)] dark:bg-[var(--surface-primary)]">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[var(--status-info)] to-[var(--brand)] flex items-center justify-center">
      ...
      {/* Footer */}
      <footer className="w-full border-t border-[var(--border-default)] dark:border-[var(--border-strong)] bg-[var(--surface-secondary)] dark:bg-[var(--surface-primary)]">
