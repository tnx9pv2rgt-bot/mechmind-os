...
import { Bell, CheckCheck, Settings, Inbox, ChevronRight, Loader2 } from 'lucide-react';
...
export function NotificationCenter({
  ...
  if (!mounted) {
    return (
      <Button variant='ghost' size='icon' className='relative h-10 w-10' aria-label='Notifiche'>
...
export function useNotificationCenter() {
  const { data: unreadCount = 0, refetch } = useQuery(['notifications', 'unread-count'], () =>
    getUnreadCount()
  );
