      ...
      <div className='space-y-4'>
        ...
        <div className='bg-white/80 backdrop-blur-xl rounded-2xl p-5 shadow-sm border border-gray-100'>
          <div className='flex items-center justify-between mb-3'>
            ...
            <button onClick={() => onEdit(0)} className='text-sm text-purple-600 hover:underline'>
              Modifica
            </button>
          </div>
        ...
        <div className='bg-white/80 backdrop-blur-xl rounded-2xl p-5 shadow-sm border border-gray-100'>
          <div className='flex items-center justify-between mb-3'>
            ...
            <button onClick={() => onEdit(1)} className='text-sm text-purple-600 hover:underline'>
              Modifica
            </button>
          </div>
        ...
        {data.customerType === 'business' && data.businessName && (
          <div className='bg-white/80 backdrop-blur-xl rounded-2xl p-5 shadow-sm border border-gray-100'>
            <div className='flex items-center justify-between mb-3'>
              ...
              <button onClick={() => onEdit(2)} className='text-sm text-purple-600 hover:underline'>
                Modifica
              </button>
            </div>
