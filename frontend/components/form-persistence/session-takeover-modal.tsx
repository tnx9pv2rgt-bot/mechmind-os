        ...
        >
          ...
          <div className="p-6 space-y-6">
            <DialogDescription className="text-gray-600 text-base">
              Abbiamo rilevato che hai iniziato una registrazione su un altro dispositivo.
              Vuoi continuare qui o mantenere l&apos;altra sessione?
            </DialogDescription>
            ...
            <div className="flex items-start gap-3 p-3 bg-amber-50 rounded-xl text-sm text-amber-700">
              ...
              <span>
                Puoi avere una sola sessione attiva per volta. 
                Se continui qui, l&apos;altra sessione verrà chiusa.
              </span>
            </div>
...
export function CurrentDeviceBadge({ sessionId, className = '' }: CurrentDeviceBadgeProps) {
  ...
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-full text-xs text-gray-600 ${className}`}>
