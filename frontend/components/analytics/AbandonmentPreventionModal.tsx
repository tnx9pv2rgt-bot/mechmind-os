...
export const AbandonmentPreventionModal: React.FC<AbandonmentPreventionModalProps> = ({
  ...
  if (variant === 'proactive') {
    return (
      <div
        className={`fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white rounded-xl shadow-lg border p-4 z-50 ${className}`}
      >
    ...
    <div className={`fixed inset-0 flex items-center justify-center bg-black/50 z-50 ${className}`}>
      <div className='bg-white rounded-lg p-6 max-w-lg w-full mx-4'>
        ...
        <div className='flex gap-2'>
          ...
          <button onClick={onClose} className='flex-1 text-gray-600 hover:text-gray-800 px-4 py-2'>
