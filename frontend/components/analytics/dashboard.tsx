  ...
  if (!data || data.length === 0) {
    return (
      <div className="text-center py-4 text-sm text-gray-500">
        Nessun dato funnel disponibile
      </div>
    );
  }
  ...
  return (
    <div className="space-y-2 mt-3">
      {data.map((step, index) => {
        ...
        const completionRate = step.started > 0 
...
const ErrorList: React.FC<{ errors: AnalyticsMetrics['errors'] }> = ({ errors }) => {
  if (!errors || errors.length === 0) {
    return (
      <div className="text-center py-2 text-xs text-green-600">
        ...
        >
          ...
          <div className="p-4 overflow-y-auto" style={{ maxHeight: '520px' }}>
            ...
            <div className="mt-4 pt-3 border-t border-gray-200/50 flex gap-2">
              <button
                onClick={() => console.log('Analytics Debug:', metrics)}
    ...
    <div className="w-[900px] h-[900px] bg-white/80 backdrop-blur-3xl rounded-3xl shadow-2xl overflow-hidden flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200/50 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {formIds.map((id) => (
              <option key={id} value={id}>Form: {id}</option>
            ))}
          </select>
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="p-4 bg-green-50/50 rounded-2xl border border-green-100">
            ...
            <div className="text-3xl font-bold text-green-900">{Math.round(metrics.completionRate)}%</div>
          ...
          <div className="p-4 bg-red-50/50 rounded-2xl border border-red-100">
            ...
            <div className="text-xs text-red-500 mt-1">{metrics.dropOffStep ? 'Necessita attenzione' : 'Ottimo!'}</div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-blue-500/10 rounded-xl border border-blue-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs bg-blue-500 text-white px-2 py-0.5 rounded-full">50% traffic</span>
              </div>
            ...
            <div className="p-4 bg-purple-500/10 rounded-xl border border-purple-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs bg-purple-500 text-white px-2 py-0.5 rounded-full">50% traffic</span>
              </div>
  ...
  return (
    <div className="flex items-center gap-4 text-sm">
      ...
      <div className="text-gray-600">
        {Math.round(metrics.completionRate)}% completamento
      </div>
      <div className="h-4 w-px bg-gray-300" />
      <div className="text-gray-600">
        {Math.round(metrics.avgTime)}s media
      </div>
    </div>
  );
};
