...
export const vehicleFormSchema = z.object({
  targa: z
    ...
    .refine(
      (val) => validateItalianPlate(val),
      'Inserisci una targa italiana valida (es. AB123CD)'
    ),
  
  marca: z
    .string()
    .min(1, 'La marca è obbligatoria'),
