...
export const AppleButton = forwardRef<HTMLButtonElement, AppleButtonProps>(
  ({ 
    ...
    const baseStyles = 'inline-flex items-center justify-center gap-2 font-medium transition-all duration-300 ease-apple rounded-pill disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]'
