    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-[var(--surface-tertiary)]">
        ...
        <div className="relative flex w-full max-w-[373px] flex-col overflow-hidden sm:max-w-[388px]">
              ...
              <div className="flex select-none justify-between items-center -mx-2">
                <div className="flex items-center">
                  {showBack && onBack && (
                    <button
                      onClick={onBack}
                      className="text-[15px] text-[var(--text-secondary)] transition-colors hover:text-[var(--text-on-brand)] min-h-[44px] min-w-[44px] flex items-center justify-center"
                      aria-label="Indietro"
                    >
                      &larr;
                    </button>
          ...
          <div className="flex items-center justify-center gap-3 px-6 pb-4 pt-0">
            <Link
              href="/terms"
              className="text-[12px] text-[var(--text-tertiary)] transition-colors hover:text-[var(--text-on-brand)] min-h-[44px] inline-flex items-center"
            >
              Condizioni d&apos;uso
            </Link>
            ...
            <Link
              href="/privacy"
              className="text-[12px] text-[var(--text-tertiary)] transition-colors hover:text-[var(--text-on-brand)] min-h-[44px] min-w-[44px] justify-center inline-flex items-center"
            >
              Privacy
            </Link>
          </div>
