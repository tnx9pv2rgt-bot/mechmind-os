  ...
  return (
    <div className="flex flex-col items-center gap-6 text-center">
      ...
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[var(--surface-secondary)]/10">
        <span className="text-3xl text-[var(--text-on-brand)]">&#9993;</span>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm font-normal text-[var(--text-on-brand)]">
          {email}
        </p>
      </div>
        ...
        <button
          ...
          className={[
            ...
            cooldown > 0 || isResending
              ...
              : 'text-[var(--text-secondary)] hover:text-[var(--text-on-brand)]',
          ].join(' ')}
        >
          {isResending
            ? 'Invio in corso...'
