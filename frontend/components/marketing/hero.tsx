    ...
    <section className='relative overflow-hidden bg-[var(--surface-secondary)] dark:bg-[var(--surface-primary)]'>
      ...
      <div className='relative z-10 mx-auto max-w-7xl px-6 pb-16 pt-16 text-center sm:pb-24 sm:pt-24 lg:px-8 lg:pb-32 lg:pt-28'>
        ...
        <motion.p
          ...
          custom={0.25}
        >
          Ordini di lavoro, fatture, prenotazioni, clienti — tutto in un&apos;unica piattaforma
        ...
        >
          {[
            ...
            <div key={stat.label} className='text-center'>
              ...
              <p className='mt-1 text-xs text-[var(--text-tertiary)] dark:text-[var(--text-secondary)]'>
                {stat.label}
              </p>
            </div>
          ))}
          ...
          {[
            ...
            >
              <div className='flex h-5 w-5 items-center justify-center rounded-full bg-[var(--status-success-subtle)]0/10 dark:bg-[var(--status-success)]/10'>
                <svg
                  className='h-3 w-3 text-[var(--status-success)] dark:text-[var(--status-success)]'
                  fill='none'
                  viewBox='0 0 24 24'
                  stroke='currentColor'
                  strokeWidth={3}
        ...
        >
          <p className='text-sm leading-relaxed text-[var(--text-secondary)] dark:text-[var(--text-secondary)]'>
            &ldquo;Da quando usiamo MechMind, il tempo per fatturare si è dimezzato. La dashboard ci
            dà una visione chiara di tutto il lavoro in officina.&rdquo;
          </p>
          <div className='mt-3 flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-[11px] text-[var(--text-tertiary)]'>
                Titolare, Autofficina Rossi — Milano
              </p>
            </div>
          </div>
        </motion.div>
