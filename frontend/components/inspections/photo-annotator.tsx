          ...
          >
            ...
            {annotation.arrowDirection && (
              <div 
                ...
                style={{
                  ...(annotation.arrowDirection === 'up' && { bottom: '100%', left: '50%', transform: 'translateX(-50%)' }),
                  ...(annotation.arrowDirection === 'down' && { top: '100%', left: '50%', transform: 'translateX(-50%)' }),
                  ...(annotation.arrowDirection === 'left' && { right: '100%', top: '50%', transform: 'translateY(-50%)' }),
                  ...(annotation.arrowDirection === 'right' && { left: '100%', top: '50%', transform: 'translateY(-50%)' }),
                }}
              >
