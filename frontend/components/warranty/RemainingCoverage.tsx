        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">Financial Coverage</span>
              </div>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Total coverage amount minus approved claims</p>
                </TooltipContent>
              </Tooltip>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-end justify-between mb-2">
                ...
                <div className={cn(
                  "text-right",
                  isLowAmount ? "text-red-600" : "text-green-600"
                )}>
              ...
              <div className="flex items-center justify-between mt-2 text-xs text-gray-500">
                <span>Used: {formatCurrency(usedCoverage)}</span>
              ...
              {isLowAmount && (
                <div className="mt-3 p-2 bg-red-50 text-red-700 text-sm rounded flex items-center gap-2">
                  ...
                  <span>Low coverage remaining</span>
                </div>
              )}
            </div>
          </div>
          ...
          {coverageKm !== null && coverageKm !== undefined && currentKm !== undefined && (
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">Mileage Coverage</span>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex items-end justify-between mb-2">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      of {coverageKm.toLocaleString()} km total
                    </div>
                  </div>
                  <div className={cn(
                    "text-right",
                    isLowKm ? "text-red-600" : "text-green-600"
                  )}>
                    <div className="text-lg font-semibold">
                ...
                <div className="flex items-center justify-between mt-2 text-xs text-gray-500">
                  <span>Used: {kmUsed.toLocaleString()} km</span>
                  <span>Remaining: {kmRemaining?.toLocaleString()} km</span>
                </div>

                {isLowKm && (
                  <div className="mt-3 p-2 bg-red-50 text-red-700 text-sm rounded flex items-center gap-2">
                    <TrendingDown className="h-4 w-4" />
                    <span>Low mileage remaining</span>
                  </div>
                )}
              </div>
            </div>
          ...
          {(coverageKm === null || coverageKm === undefined) && (
            <div className="flex items-center gap-2 p-3 bg-green-50 text-green-700 rounded-lg text-sm">
              ...
              <span>Unlimited mileage coverage</span>
            </div>
          )}
        </CardContent>
      </Card>
