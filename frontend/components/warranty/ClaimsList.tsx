          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value={ClaimStatus.SUBMITTED}>
                Inviato ({statusCounts[ClaimStatus.SUBMITTED]})
              </SelectItem>
              <SelectItem value={ClaimStatus.UNDER_REVIEW}>
                In Revisione ({statusCounts[ClaimStatus.UNDER_REVIEW]})
              </SelectItem>
              <SelectItem value={ClaimStatus.APPROVED}>
                Approvato ({statusCounts[ClaimStatus.APPROVED]})
              </SelectItem>
              <SelectItem value={ClaimStatus.REJECTED}>
                Rifiutato ({statusCounts[ClaimStatus.REJECTED]})
              </SelectItem>
              <SelectItem value={ClaimStatus.PAID}>
                Pagato ({statusCounts[ClaimStatus.PAID]})
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
